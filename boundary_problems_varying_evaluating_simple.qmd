...
def generate_random_territory_allocation(
    ...
    allocated_territory_list = list(starting_territories[territory_unit_column].unique())
    ...
    for player in player_list:
        ...
        # Only add the territory if it's not already in the list of owned territory
        if selected_territory not in allocated_territory_list:
            ...
            allocated_territory_list.append(selected_territory)

    # Keep going through the following process until all territory has been allocated
    while len(allocated_territory_list) < len(gdf[territory_unit_column].unique()):
