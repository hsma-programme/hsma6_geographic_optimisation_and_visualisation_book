...
However, if you're interested in learning about an alternate, less 'busy' looking basemap, or if you want to use a different basemap to the default one provided by QGIS, then you can carry on to the sections below.
