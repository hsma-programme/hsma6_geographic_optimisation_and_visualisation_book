...
![](images\crs_projections_cartesian_grid_comparison.png)
...
![Mercator Projection](images\Mercator_projection_Square.JPG){.lightbox width=600}
...
In the Gall-Peters projection, the sizes of

![Gall-Peters Projection](images\Gall–Peters_projection_SW.jpg){.lightbox width=600}
...
![Winkel Tripel Projection](images\Winkel_triple_projection_SW.jpg){.lightbox width=600}
