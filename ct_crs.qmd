...
![](images/crs_uk_postcodes.png){.lightbox}^https://upload.wikimedia.org/wikipedia/commons/thumb/f/fe/British_postcode_areas_map.svg/450px-British_postcode_areas_map.svg.png
...
```{=html}
<iframe width="780" height="700" src="https://houseofcommonslibrary.github.io/msoanames/map/
" title="MSOA Map"></iframe>
```
:::
...
![](images/crs_local_authorities.png){.lightbox}^https://en.wikipedia.org/wiki/Local_government_in_England
...
![](images/crs_icb.png){.lightbox}^https://geoportal.statistics.gov.uk/documents/ons::integrated-care-boards-april-2023-map-in-england/explore

#### Ambulance Trusts

![](images/crs_ambulance_trusts.png){.lightbox}^https://www.bbc.co.uk/news/health-16052725


#### Police Forces

![](images/crs_police_forces.png){.lightbox}^https://assets-hmicfrs.justiceinspectorates.gov.uk/uploads/police-force-map.pdf
